export default function middleware(request) {
  ...
  const paginasBloqueadas = ['/hml', '/dgf', '/simuapos', '/aposentados', '/calcdata', '/calendario', '/dash', '/efetivo', '/fluxomaker', '/organomaker', '/simulador', '/simupai', '/simusaude', '/transformador', '/impacto'];
